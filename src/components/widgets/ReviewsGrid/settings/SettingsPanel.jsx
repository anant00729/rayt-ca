  ...
  const renderContent = () => (
    <>
      ...
      <Section label="Toggles">
        <CheckRow label="Show review title" checked={!!settings.showReviewTitle} onChange={(e) => set('showReviewTitle', e.target.checked)} />
        ...
        {settings.truncateText && (
          <NestedGroup>
            <SliderField label="Max lines" settingKey="maxLines" settings={settings} set={set} min={2} max={12} step={1} defaultValue={4} suffix="" />
          </NestedGroup>
        )}
      </Section>
    </>
  ...
  const renderDesign = () => (
    <>
      <Section label="Container" defaultOpen>
        ...
        <SliderField label="Max width" settingKey="containerMaxWidth" settings={settings} set={set} min={600} max={1600} step={20} defaultValue={1200} />
      </Section>
      ...
      <Section label="Card">
        ...
        <SliderField label="Corner radius" settingKey="cardBorderRadius" settings={settings} set={set} min={0} max={32} step={1} defaultValue={12} />
        <SliderField label="Padding" settingKey="cardPadding" settings={settings} set={set} min={8} max={40} step={2} defaultValue={16} />
        <FieldGroup>
      ...
      <Section label="Reviewer">
        ...
        <SliderField label="Name size" settingKey="reviewerNameSize" settings={settings} set={set} min={11} max={22} step={1} defaultValue={14} />
        <FieldGroup>
      ...
      <Section label="Review text">
        {settings.showReviewTitle && (
          <ColorPaletteWrap>
            <ColorField fieldKey="reviewTitleColor" label="Title color" value={settings.reviewTitleColor} onChange={set} />
          </ColorPaletteWrap>
        )}
        <ColorPaletteWrap>
          <ColorField fieldKey="reviewTextColor" label="Body color" value={settings.reviewTextColor} onChange={set} />
        </ColorPaletteWrap>
